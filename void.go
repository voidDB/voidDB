...
// data loss (and potentially database corruption, albeit only if the
// filesystem does not observe write ordering) in the event of a crash at the
// level of the operating system or lower, e.g. hardware or power failure.
